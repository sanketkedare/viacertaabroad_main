    ...
    <section className=" py-16 min-h-screen">
      <div className="container mx-auto lg:px-10 lg:w-9/12 m-auto">
        ...
        <div className="text-center mb-12">
          <h2 className="lg:text-4xl text-xl font-bold text-[#2c31b6]">
            Why Choose ViaCerta Abroad?
          </h2>
          <p className="lg:text-lg  mt-4 w-3/4 mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 text-[#f8b62d] px-4">
          {benefits.map((benefit, index) => (
            <div
              key={index}
              className="bg-[#152347] p-6 rounded-xl shadow-lg flex items-start gap-4"
            >
