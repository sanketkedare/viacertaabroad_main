    ...
    <section className="bg-white py-16">
      <div className="container mx-auto px-10 lg:w-9/12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="lg:text-lg  text-gray-600 mt-4 lg:w-3/4 mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-10 text-white">
          ...
          <div className="bg-[#152347] p-8 rounded-xl shadow-lg text-center">
            <h3 className="lg:text-2xl font-semibold text-[#f8b62d]">Global University Access</h3>
          ...
          {/* Service 2 */}
          <div className="bg-[#152347] p-8 rounded-xl shadow-lg text-center">
            <h3 className="lg:text-2xl font-semibold text-[#f8b62d]">Scholarships & Funding</h3>
            <p className="mt-3 text-sm text-gray-300">
          ...
          {/* Service 3 */}
          <div className="bg-[#152347] p-8 rounded-xl shadow-lg text-center">
            <h3 className="lg:text-2xl font-semibold text-[#f8b62d]">Visa & Application Support</h3>
            <p className="mt-3 text-sm text-gray-300">
        ...
        <div className="mt-16 flex flex-col md:flex-row items-center gap-10">
          {/* CEO Image */}
          <div className="lg:w-1/3 rounded-full overflow-hidden shadow-lg">
            <img
              src={CEO_URL}
              alt="CEO"
          ...
          {/* CEO Info */}
          <div>
            <h3 className="lg:text-3xl text-xl font-bold text-[#2c31b6]">John Doe</h3>
            <p className="lg:text-lg  text-[#152347] font-semibold">Founder & CEO, ViaCerta Abroad</p>
