...
const ServicesForm = () => {
    ...
    return (
      <motion.div
        ...
        className="lg:w-[400px] w-11/12 absolute lg:top-5 bottom-2 lg:right-5 right-4 lg:h-[80%] h-[75%]  bg-white rounded-xl shadow-lg z-30 m-auto"
      >
        ...
        <div className="flex lg:items-end items-center py-10 h-full w-full justify-center ">
