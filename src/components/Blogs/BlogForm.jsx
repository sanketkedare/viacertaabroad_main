...
import PopupComponent from '../Services/PopUp';

const BlogForm = ({title="Get FREE Counselling Today!", buttonText= "Book Now"}) => {
  ...
  return (
    <>
      ...
      <motion.div
        ...
        className=" lg:col-span-1 bg-white rounded-xl shadow-lg text-sm z-30 m-auto w-full lg:min-h-[400px]"
      >
