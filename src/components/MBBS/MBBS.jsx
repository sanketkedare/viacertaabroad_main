...
const MBBS = () => {
  const commonData = {
    ...
    intro:{
        ...
        content:"Studying MBBS abroad is an excellent choice for students who want a high-quality medical education at an affordable cost. Many countries offer medical programs that are globally recognized, ensuring that students have access to international career opportunities.\nAt ViaCerta Abroad, we simplify the entire admission process, making it easier for you to secure a seat in top medical universities without unnecessary stress."
    },
    benifits:{
