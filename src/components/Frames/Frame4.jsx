...
const Frame4 = ({heading, info}) => {
  const h = heading || "Hey You, Your Future Is Calling–Let’s Get You Abroad"
  const i = info || "Answer the Call, your future shouldn’t be on hold."
  return (
